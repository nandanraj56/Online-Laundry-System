<%-- 
    Document   : merchant-closed-orders
    Created on : 7 Apr, 2018, 11:18:48 PM
    Author     : nandanraj56
--%>
...
<html>
    ...
    <%
        ...
        PreparedStatement pt1=con.prepareStatement("select * from orders where email=? and status='Delivered'");
