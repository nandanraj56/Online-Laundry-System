<%-- 
    Document   : merchant-pickedup-processing
    Created on : 7 Apr, 2018, 11:17:05 PM
    Author     : nandanraj56
--%>
...
<html>
    ...
    <%
        ...
        PreparedStatement pt1=con.prepareStatement("select * from orders where email=? and (status='Pickup done' or status='Processing')");
    ...
    <!--End of actionmodal-->                    
        ...
        <div class="main">
        <div class="container">
            <h1>Orders: Picked Up & Processing</h1>
