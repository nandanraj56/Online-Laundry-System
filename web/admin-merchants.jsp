<%-- 
    Document   : admin-merchants
    Created on : 10 Apr, 2018, 10:33:16 AM
    Author     : nandanraj56
--%>
...
<html>
    ...
    <%
        ...
        PreparedStatement pt1=con.prepareStatement("select merchant.merchantname,merchant.email,merchant.phone,merchantaddress.addr,merchantaddress.city,merchantaddress.region,merchant.about,merchant.userblock from merchant inner join merchantaddress on merchant.email=merchantaddress.email");
    ...
    <body class="corporate">
        ...
        <div class="container">
            ...
            <%if(!rs1.isBeforeFirst()){%>
                ...
                <div class="panel-body">No Merchants to Show</div>
            ...
            <table class="table table-bordered">
                ...
                <%while(rs1.next()){%>
                    <tr>
                        ...
                        <td>
                            <form action="AdminMerchantBlock">
                                <input type="text" name="emailforblock" value="<%=rs1.getString(2)%>" hidden>
