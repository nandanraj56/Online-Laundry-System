<%-- 
    Document   : admin-pending-orders
    Created on : 10 Apr, 2018, 1:12:04 AM
    Author     : nandanraj56
--%>
...
<html>
    ...
    <%
        ...
        PreparedStatement pt1=con.prepareStatement("select * from orders where (status='Pick Up Requested' or status='Pickup done' or status='Processing' or status='Out for Delivery')");
