<%-- 
    Document   : merchant-tobedelivered
    Created on : 7 Apr, 2018, 11:17:43 PM
    Author     : nandanraj56
--%>
...
<html>
    ...
    <%
        ...
        PreparedStatement pt1=con.prepareStatement("select * from orders where email=? and status='Out for Delivery'");
